...
/*****************************************************************************/
public class Example22_UtilsSVC extends Example22_ServiceControlManagement
{
	/*******************************************/
	public static void updateList(Example22_TableSVC tableSvc)
	{
		if(tableSvc==null)
			return;
	...
	/*******************************************/
	public static void updateList(Example22_TableSVC tableSvc, String[] svcInfo)
	{
